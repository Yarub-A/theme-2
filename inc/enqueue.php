...
add_action( 'enqueue_block_editor_assets', function () {
    ...
    wp_enqueue_script(
        'renita-blocks-editor',
        RENITA_THEME_URI . '/assets/js/blocks.js',
        [ 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-components', 'wp-block-editor', 'wp-server-side-render' ],
        RENITA_THEME_VERSION,
        true
    );
} );
